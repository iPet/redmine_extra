...
class BoardsController < ApplicationController
  ...
  before_filter :find_project_by_project_id, :only => [:index, :create, :show]
  before_filter :find_board_if_available  
  before_filter :authorize, :except => [:index, :create]
  before_filter :find_optional_project, :only => [:index, :create, :show]
